 ...
 * Busybox version: 1.22.1-Dorimanx
 */
#define AUTOCONF_TIMESTAMP "2014-02-08 21:10:13 IST"
...
#define CONFIG_CROSS_COMPILER_PREFIX "/android-kernel/android-ndk-r9c/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi-"
...
#define CONFIG_SYSROOT "/android-kernel/android-ndk-r9c/platforms/android-17/arch-arm"
...
#define CONFIG_EXTRA_CFLAGS "-DANDROID -D__ANDROID__ -DSK_RELEASE -nostdlib -march=armv7-a -msoft-float -mthumb-interwork -fpic -fno-short-enums -fgcse-after-reload -frename-registers"
...
#ifdef MAKE_SUID
# define IF_FEATURE_BASH_IS_HUSH(...) __VA_ARGS__ "CONFIG_FEATURE_BASH_IS_HUSH"
#else
